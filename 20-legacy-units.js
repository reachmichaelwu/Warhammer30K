...
(function installLegacyUnits() {
  ...
  var LEGACY_UNIT_DEFS = [
    ...
    def("land_raider_achilles_legacy", "Land Raider Achilles", C.htrans, "heavy_transport", 280, 0, 1, 1, stats(4, 8, 10, 2, "-", 8, { isVehicle: true, avF: 14, avS: 14, avR: 14, hp: 6 }), ["Auto-repair (5+)"]),
    ...
    def("cyclops_demolition_legacy", "Cyclops Demolition Vehicle", "SA: LEGACY SUPPORT", "support", 50, 0, 1, 1, stats(0, 6, 2, 4, "-", 6, { isVehicle: true, avF: 10, avS: 10, avR: 10, hp: 2 }), ["Expendable (3)", "Explodes (2+)", "Compact", "Demolition Vehicle"]),
    def("aurox_transport_legacy", "Aurox Transport", "SA: LEGACY TRANSPORT", "transport", 50, 0, 1, 1, stats(3, 6, 3, 4, "-", 7, { isVehicle: true, avF: 11, avS: 11, avR: 10, hp: 3 }), ["Light Transport"]),
    def("sa_tarantula_section_legacy", "Tarantula Section", "SA: LEGACY SUPPORT", "support", 35, 0, 2, 2, stats(0, 6, 2, 4, "-", 6, { isVehicle: true, avF: 10, avS: 10, avR: 10, hp: 2 }), ["Expendable (3)", "Automated Fire Protocols", "Independent Sentries"]),
    def("carnodon_legacy", "Carnodon Strike Tank", "SA: LEGACY ARMOUR", "armour", 80, 0, 1, 1, stats(3, 7, 4, 3, "-", 7, { isVehicle: true, avF: 12, avS: 12, avR: 10, hp: 4 }), []),
    def("avenger_strike_fighter_legacy", "Avenger Strike Fighter", "SA: LEGACY FAST ATTACK", "fast_attack", 100, 0, 1, 1, stats(3, 7, 4, 3, "-", 7, { isVehicle: true, avF: 11, avS: 11, avR: 10, hp: 4 }), ["Flyer"]),
    def("destroyer_tank_hunter_legacy", "Destroyer Tank Hunter", "SA: LEGACY ARMOUR", "armour", 130, 0, 1, 1, stats(3, 8, 5, 2, "-", 7, { isVehicle: true, avF: 14, avS: 12, avR: 10, hp: 5 }), []),
    def("thunderer_siege_tank_legacy", "Thunderer Siege Tank", "SA: LEGACY ARMOUR", "armour", 155, 0, 1, 1, stats(3, 8, 5, 2, "-", 7, { isVehicle: true, avF: 14, avS: 13, avR: 10, hp: 5 }), []),
    def("minotaur_artillery_tank_legacy", "Minotaur Artillery Tank", "SA: LEGACY SUPPORT", "support", 205, 0, 1, 1, stats(3, 8, 6, 2, "-", 7, { isVehicle: true, avF: 14, avS: 12, avR: 10, hp: 6 }), []),
    def("macharius_legacy", "Macharius Heavy Tank", "SA: LEGACY LORD OF WAR", "lord_of_war", 300, 0, 1, 1, stats(3, 8, 8, 2, "-", 8, { isVehicle: true, avF: 14, avS: 13, avR: 12, hp: 8 }), []),
    def("praetor_launcher_legacy", "Praetor Armoured Assault Launcher", "SA: LEGACY ARMOUR", "armour", 300, 0, 1, 1, stats(3, 8, 6, 2, "-", 7, { isVehicle: true, avF: 14, avS: 12, avR: 10, hp: 6 }), []),
    def("crassus_transport_legacy", "Crassus Armoured Assault Transport", "SA: LEGACY HEAVY TRANSPORT", "heavy_transport", 350, 0, 1, 1, stats(3, 8, 8, 2, "-", 7, { isVehicle: true, avF: 14, avS: 14, avR: 12, hp: 8 }), []),
    def("baneblade_legacy", "Baneblade", "SA: LEGACY LORD OF WAR", "lord_of_war", 520, 0, 1, 1, stats(3, 9, 12, 2, "-", 8, { isVehicle: true, avF: 14, avS: 13, avR: 12, hp: 12 }), []),
    def("hellhammer_legacy", "Hellhammer", "SA: LEGACY LORD OF WAR", "lord_of_war", 520, 0, 1, 1, stats(3, 9, 12, 2, "-", 8, { isVehicle: true, avF: 14, avS: 13, avR: 12, hp: 12 }), []),
    def("banehammer_legacy", "Banehammer", "SA: LEGACY LORD OF WAR", "lord_of_war", 450, 0, 1, 1, stats(3, 9, 12, 2, "-", 8, { isVehicle: true, avF: 14, avS: 13, avR: 12, hp: 12 }), []),
    def("stormlord_legacy", "Stormlord", "SA: LEGACY LORD OF WAR", "lord_of_war", 500, 0, 1, 1, stats(3, 9, 12, 2, "-", 8, { isVehicle: true, avF: 14, avS: 13, avR: 12, hp: 12 }), ["Light Transport"]),
    def("stormblade_legacy", "Stormblade", "SA: LEGACY LORD OF WAR", "lord_of_war", 500, 0, 1, 1, stats(3, 9, 12, 2, "-", 8, { isVehicle: true, avF: 14, avS: 13, avR: 12, hp: 12 }), []),
    def("shadowsword_legacy", "Shadowsword", "SA: LEGACY LORD OF WAR", "lord_of_war", 475, 0, 1, 1, stats(3, 9, 12, 2, "-", 8, { isVehicle: true, avF: 14, avS: 13, avR: 12, hp: 12 }), []),
    def("stormsword_legacy", "Stormsword", "SA: LEGACY LORD OF WAR", "lord_of_war", 475, 0, 1, 1, stats(3, 9, 12, 2, "-", 8, { isVehicle: true, avF: 14, avS: 13, avR: 12, hp: 12 }), []),
    def("marauder_bomber_legacy", "Marauder Bomber", "SA: LEGACY FAST ATTACK", "fast_attack", 225, 0, 1, 1, stats(3, 8, 8, 2, "-", 7, { isVehicle: true, avF: 11, avS: 11, avR: 10, hp: 8 }), ["Flyer"]),
    def("marauder_destroyer_legacy", "Marauder Destroyer", "SA: LEGACY FAST ATTACK", "fast_attack", 245, 0, 1, 1, stats(3, 8, 8, 2, "-", 7, { isVehicle: true, avF: 11, avS: 11, avR: 10, hp: 8 }), ["Flyer"]),
    ...
    def("mechanicum_termite_legacy", "Mechanicum Termite", "MECH: LEGACY TRANSPORT", "transport", 80, 0, 1, 1, stats(4, 7, 3, 3, "-", 7, { isVehicle: true, avF: 11, avS: 11, avR: 10, hp: 3 }), ["Light Transport", "Deep Strike"]),
    def("mechanicum_tarantula_legacy", "Mechanicum Tarantula Battery", "MECH: LEGACY SUPPORT", "support", 45, 0, 2, 2, stats(0, 6, 2, 4, "-", 6, { isVehicle: true, avF: 10, avS: 10, avR: 10, hp: 2 }), ["Expendable (3)", "Infiltrate (9)", "Automated Fire Protocols", "Independent Sentries"]),
    def("macrocarid_explorator_legacy", "Macrocarid Explorator", "MECH: LEGACY TRANSPORT", "transport", 200, 0, 1, 1, stats(4, 8, 6, 2, 5, 8, { isVehicle: true, avF: 13, avS: 13, avR: 12, hp: 6 }), ["Auto-repair (3+)", "Move Through Cover", "Anbaric Claw"]),
    ...
    def("hammerfall_bunker_legacy", "Hammerfall Bunker", C.fort, "fortification", 150, 0, 1, 1, stats(2, 8, 8, 3, "-", 6, { isVehicle: true, avF: 12, avS: 12, avR: 12, hp: 8 }), ["Fortification", "Bunker", "Forward Deployment"]),
    def("void_shield_generator_legacy", "Void Shield Generator", C.fort, "fortification", 120, 0, 1, 1, stats(0, 7, 6, 3, "-", 6, { isVehicle: true, avF: 11, avS: 11, avR: 11, hp: 6 }), ["Fortification", "Structure", "Void Shield"]),
    def("skyshield_landing_pad_legacy", "Skyshield Landing Pad", C.fort, "fortification", 100, 0, 1, 1, stats(0, 7, 6, 3, "-", 6, { isVehicle: true, avF: 11, avS: 11, avR: 11, hp: 6 }), ["Fortification", "Platform", "Landing Pad", "Forward Deployment"]),
    def("aegis_defence_line_legacy", "Aegis Defence Line", C.fort, "fortification", 70, 0, 1, 1, stats(0, 6, 6, 4, "-", 6, { isVehicle: true, avF: 10, avS: 10, avR: 10, hp: 6 }), ["Fortification", "Armoured Platform", "Aegis Barricades"]),
    def("firestorm_redoubt_legacy", "Firestorm Redoubt", C.fort, "fortification", 200, 0, 1, 1, stats(2, 8, 10, 3, "-", 6, { isVehicle: true, avF: 12, avS: 12, avR: 12, hp: 10 }), ["Fortification", "Bunker", "Firing Point (3)"]),
    def("fortress_redemption_legacy", "Fortress of Redemption", C.fort, "fortification", 300, 0, 1, 1, stats(2, 9, 12, 2, "-", 6, { isVehicle: true, avF: 14, avS: 14, avR: 14, hp: 12 }), ["Fortification", "Bunker", "Orbital Defence"]),
    def("aquila_strongpoint_legacy", "Aquila Strongpoint", C.fort, "fortification", 100, 0, 1, 1, stats(2, 8, 10, 3, "-", 6, { isVehicle: true, avF: 12, avS: 12, avR: 12, hp: 10 }), ["Fortification", "Bunker", "Firing Point (3)"]),
    def("primus_redoubt_legacy", "Primus Redoubt", C.fort, "fortification", 400, 0, 1, 1, stats(2, 9, 14, 2, "-", 6, { isVehicle: true, avF: 14, avS: 14, avR: 14, hp: 14 }), ["Fortification", "Bunker", "Macro-auspex"]),
