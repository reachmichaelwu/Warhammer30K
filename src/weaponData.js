...
export const UNIT_BATTLEFIELD_ROLE = {
  // WARLORD (Primarchs)
...
export const ADDITIONAL_DETACHMENTS = {
  warlord_det: {
...
export const ALLIED_FACTION_CATEGORIES = ["SOLAR AUXILIA", "MECHANICUM", "CUSTODES"];

// Auxiliary Detachments — each Command slot filled unlocks 1 (p.284)
export const AUXILIARY_DETACHMENTS = {
...
export const ALLEGIANCE_PRIME_ADVANTAGES = [
...
export const LEGION_PRIME_ADVANTAGES = {
  emperors_children: [
...
export const LEGION_DETACHMENTS = {
  dark_angels: {
    auxiliary: [
...
export const LOGISTICAL_EXCLUDED_ROLES = ["high_command", "command", "warlord", "lord_of_war"];

export const ALLEGIANCE_UNITS = {
  loyalist: [
    // Primarchs
...
export function formatWargear(entry, faction) {
...
export function calcArmyEntryPoints(entry) {
...
export function getUnitsForRole(role) {
...
export const SERGEANT_MELEE_WEAPONS = {
  astartes: [
...
export function getSgtCategory(unitId) {
