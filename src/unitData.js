...
export function getLegionWargearOptions(unitId, faction) {
...
export function getWargearOptions(unitId, faction) {
...
export const UNIT_EQUIPMENT_ACCESS = {
...
export function canTakeEquipment(unitId, equipKey) {
  if (!equipKey) {
...
export const LEGION_WEAPON_PROFILES = {
  // I Dark Angels
  deathwing_comp: [
...
export function MELEE_getRangedWeapons(unitId) {
...
export const UNIT_WARGEAR_OPTIONS = {
  // ── HIGH COMMAND ──
  praetor_pa: [
