...
import { BS_TO_HIT, CRITICAL_HIT_THRESHOLD, getWoundRoll, rollD6, rollD6s, WEAPON_TYPES, SPECIAL_RULES, UNIT_PRESETS, UNIT_FOC_SLOT } from './constants.js';
import { getLegionWargearOptions, getWargearOptions, EQUIPMENT_OPTIONS, UNIT_EQUIPMENT_ACCESS, canTakeEquipment, POINTS_DATA, WEAPON_UPGRADE_COSTS, LEGION_WEAPON_PROFILES, UNIT_WARGEAR_OPTIONS } from './unitData.js';
import { BATTLEFIELD_ROLES, UNIT_BATTLEFIELD_ROLE, CRUSADE_PRIMARY, ADDITIONAL_DETACHMENTS, AUXILIARY_DETACHMENTS, APEX_DETACHMENTS, LEGION_PRIME_ADVANTAGES, LEGION_DETACHMENTS, ALLEGIANCE_UNITS, MAX_UNIT_SIZE, formatWargear, calcArmyEntryPoints, getUnitsForRole, calcUnitPoints, WEAPON_PROFILES, SERGEANT_WEAPONS, SERGEANT_MELEE_WEAPONS, getSgtCategory, PRIME_ADVANTAGES, ALLEGIANCE_PRIME_ADVANTAGES, LEGION_FACTIONS, LOGISTICAL_EXCLUDED_ROLES, ALLIED_FACTION_CATEGORIES } from './weaponData.js';
import { resolveShootingPhase, resolveReturnFire, calculateExpected, resolveChallenge, resolveWeaponGroup, resolveAssaultPhase, WS_TO_HIT_CHART, getMeleeToHit, MELEE_WEAPON_PROFILES, LEGION_MELEE_WEAPONS, LEGION_RANGED_WEAPONS, getSetUpMove, resolveChargePhase, CHALLENGE_GAMBITS, MELEE_SPECIAL_RULES } from './resolvers.js';
import { getUnitIconType, UnitIcon, UnitSelectorModal, WeaponSelector, phaseColors, phaseIcons, DieIcon, NumberInput, stepBtnStyle, SelectInput, ToggleChip, CheckToggle } from './components.jsx';
import { StatBox, MiniStat, panelStyle, panelHeaderStyle, refCellStyle } from './helpers.js';
