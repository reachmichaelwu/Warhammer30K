import { rollD6, rollD6s, getWoundRoll, UNIT_PRESETS, UNIT_FOC_SLOT } from './constants.js';
import { WEAPON_PROFILES, SERGEANT_WEAPONS, SERGEANT_MELEE_WEAPONS, getSgtCategory } from './weaponData.js';


export function resolveShootingPhase(params) {
  const {
...
export function resolveReturnFire(params) {
  const {
...
export const CHALLENGE_GAMBITS = [
...
export function resolveChallenge(params) {
  const {
    // Attacker champion
...
export function resolveWeaponGroup(group, remainTarget, log) {
...
export function resolveAssaultPhase(params) {
  const {
...
export function getRangedWeapons(unitId) {
...
export function getMeleeToHit(attackerWS, defenderWS) {
  if (attackerWS > defenderWS) return 3;
  if (attackerWS === defenderWS) return 4;
  return 5;
}

export const MELEE_SPECIAL_RULES = [
...
export const MELEE_WEAPON_PROFILES = {
  // LEGIONES ASTARTES
  tactical: [
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
export const LEGION_MELEE_WEAPONS = {
  dark_angels: [
...
export const LEGION_RANGED_WEAPONS = {
  dark_angels: [
...
export function getSetUpMove(initiative, movement) {
...
export function resolveChargePhase(params) {
  const {
