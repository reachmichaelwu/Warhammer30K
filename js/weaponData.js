(function() {
const { BS_TO_HIT, CRITICAL_HIT_THRESHOLD, getWoundRoll, rollD6, rollD6s, WEAPON_TYPES, SPECIAL_RULES, UNIT_PRESETS, UNIT_FOC_SLOT, getLegionWargearOptions, getWargearOptions, EQUIPMENT_OPTIONS, UNIT_EQUIPMENT_ACCESS, canTakeEquipment, POINTS_DATA, WEAPON_UPGRADE_COSTS, LEGION_WEAPON_PROFILES, getRangedWeapons, MELEE_getRangedWeapons, UNIT_WARGEAR_OPTIONS } = window.HH;
...
const ALLIED_FACTION_CATEGORIES = ["SOLAR AUXILIA", "MECHANICUM", "CUSTODES"];

// Auxiliary Detachments — each Command slot filled unlocks 1 (p.284)
const AUXILIARY_DETACHMENTS = {
...
const ALLEGIANCE_PRIME_ADVANTAGES = [
...
const LOGISTICAL_EXCLUDED_ROLES = ["high_command", "command", "warlord", "lord_of_war"];

const ALLEGIANCE_UNITS = {
  loyalist: [
    // Primarchs
