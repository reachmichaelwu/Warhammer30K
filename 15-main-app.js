              ...
              return (
                React.createElement("div", {"key": si, "style": { marginBottom: 10 }}, React.createElement("div", {"style": { display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}, React.createElement("span", {"style": { fontSize: 13, color: role?.color || "#8a7e6e" }}, role?.icon), React.createElement("span", {"style": { fontFamily: "'Share Tech Mono', serif", fontWeight: 700, fontSize: 13, color: role?.color || "#6a5e4e", letterSpacing: 1 }}, role?.label?.toUpperCase(), "×", slot.count), (slot.prime || slot.primeCount) && React.createElement("span", {"style": { fontSize: 8, color: "#d4af37", fontWeight: 600, border: "1px solid #d4af37", borderRadius: 3, padding: "1px 4px" }}, "PRIME", slot.primeCount ? ` (${slot.primeCount}/${slot.count})` : ""), React.createElement("span", {"style": { fontSize: 11, color: "#8a7e6e", marginLeft: 4 }}, "(", filledEntries.length, "/", slot.count, "filled)")), filledEntries.map((entry, ei) => {
                    ...
                    return (
                      React.createElement("div", {"key": entry.id, "style": {
                        ...
                        border: entry.isWarlord ? "1.5px solid #d4af37" : (entry.isPrime ? "1.5px solid rgba(212,175,55,0.4)" : "1px solid #050705"),
                      }}, React.createElement("div", {"style": { flex: 1, minWidth: 0 }}, React.createElement("div", {"style": { fontFamily: "'Share Tech Mono', serif", fontWeight: 700, fontSize: 13, color: "#2a2418", display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap" }}, entry.unitName, entry.isWarlord && React.createElement("span", {"style": { fontSize: 8, color: "#d4af37" }}, "👑"), entry.isPrime && React.createElement("span", {"style": { fontSize: 7, color: "#d4af37", fontWeight: 700, border: "1px solid #d4af37", borderRadius: 2, padding: "0 3px" }}, "★PRIME")), React.createElement("div", {"style": { fontSize: 11, color: "#8a7e6e", fontFamily: "'Share Tech Mono', serif" }}, entry.models, "mdl", entry.weaponName ? ` · ${entry.weaponName}` : "", entry.secondaryWeapons && entry.secondaryWeapons.length > 0 ? entry.secondaryWeapons.map(sw => ` · +${sw.models}× ${sw.weaponName}`).join("") : "", entry.sgtWeaponName ? ` · Sgt:${entry.sgtWeaponName}` : "", formatWargear(entry)), entry.primeAdvantage && (() => {
                          ...
                          })()), React.createElement("span", {"style": { fontFamily: "'Share Tech Mono', serif", fontWeight: 700, fontSize: 13, color: "#4a6741" }}, pts, "pts"), entryRole === "high_command" && (
                    ...
                    React.createElement("div", {"key": si, "style": { marginBottom: 8 }}, React.createElement("div", {"style": { display: "flex", alignItems: "center", gap: 5, marginBottom: 3 }}, React.createElement("span", {"style": { fontSize: 13, color: role?.color }}, role?.icon), React.createElement("span", {"style": { fontFamily: "'Share Tech Mono', serif", fontWeight: 700, fontSize: 12, color: role?.color, letterSpacing: 1 }}, role?.label?.toUpperCase(), "×", slot.count), (slot.prime || slot.primeCount) && React.createElement("span", {"style": { fontSize: 7, color: "#d4af37", fontWeight: 600, border: "1px solid #d4af37", borderRadius: 3, padding: "0px 3px" }}, "PRIME", slot.primeCount ? ` (${slot.primeCount}/${slot.count})` : ""), React.createElement("span", {"style": { fontSize: 8, color: "#8a7e6e" }}, "(", filledEntries.length, "/", slot.count, ")")), filledEntries.map((entry) => {
                        ...
                        return (
                          React.createElement("div", {"key": entry.id, "style": { display: "flex", alignItems: "center", gap: 6, padding: "5px 8px", marginBottom: 2, borderRadius: 4, background: entry.isPrime ? "rgba(212,175,55,0.06)" : "#faf8f4", border: entry.isPrime ? "1px solid rgba(212,175,55,0.3)" : "1px solid #050705" }}, typeof getUnitArtwork === "function" && getUnitArtwork(entry.unitId, getArmy().faction) ? React.createElement("img", { src: getUnitArtwork(entry.unitId, getArmy().faction), alt: "", style: { width: 76, height: 76, objectFit: "cover", borderRadius: 4, flexShrink: 0, border: "1px solid rgba(184,134,11,0.2)" }, onError: function(e) { e.currentTarget.style.display = "none"; } }) : null, React.createElement("div", {"style": { flex: 1 }}, React.createElement("div", {"style": { fontFamily: "'Share Tech Mono', serif", fontWeight: 600, fontSize: 12, color: "#2a2418" }}, entry.unitName, entry.isPrime && React.createElement("span", {"style": { fontSize: 7, color: "#d4af37", marginLeft: 4, fontWeight: 700, border: "1px solid #d4af37", borderRadius: 2, padding: "0 2px" }}, "★PRIME")), React.createElement("div", {"style": { fontSize: 8, color: "#8a7e6e" }}, entry.models, "mdl", entry.weaponName ? ` · ${entry.weaponName}` : "", entry.secondaryWeapons && entry.secondaryWeapons.length > 0 ? entry.secondaryWeapons.map(sw => ` · +${sw.models}× ${sw.weaponName}`).join("") : "", formatWargear(entry)), entry.primeAdvantage && (() => {
                              ...
                              })()), React.createElement("span", {"style": { fontFamily: "'Share Tech Mono', serif", fontWeight: 700, fontSize: 12, color: "#4a6741" }}, pts, "pts"), React.createElement("button", {"onClick": () => { setAbEditIdx(getArmy().entries.indexOf(entry)); setAbEditEntry({ ...entry, faction: getArmy().faction }); setAbAddModalOpen(true); }, "style": { padding: "2px 5px", borderRadius: 3, fontSize: 8, cursor: "pointer", background: "#f0ebe2", border: "1px solid #d0c4aa", color: "#6a5e4e" }}, "✎"), React.createElement("button", {"onClick": () => setArmy(prev => ({ ...prev, entries: prev.entries.filter(e => e.id !== entry.id) })), "style": { padding: "2px 5px", borderRadius: 3, fontSize: 8, cursor: "pointer", background: "rgba(155,45,45,0.08)", border: "1px solid rgba(155,45,45,0.3)", color: "#9b2d2d" }}, "✕"))
                        );
                      }), remaining > 0 && (
