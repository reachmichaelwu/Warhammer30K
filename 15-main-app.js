  ...
  const getAvailableUnitsForRole = useCallback(
    (role, detachmentId) => {
      ...
      return allUnits.filter((u) => {
        ...
        if (isAllied) {
          // Allied Detachment command slots allow all legion command units
          // (they also unlock Auxiliary Detachments just like normal command slots).
          // All other slots (troops, etc.) are restricted to Solar Auxilia, Mechanicum, Custodes.
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              "THE HORUS HERESY · AGE OF DARKNESS · 3RD EDITION · v1.75",
            ),
          ),
        ),
        React.createElement(
          ...
          showFiringVideo &&
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  "span",
                  { style: { fontSize: 28, color: "#c8a84b" } },
                  "⚔",
                ),
                React.createElement(
                  "span",
              ...
              React.createElement(
                ...
                React.createElement("img", {
                  ...
                  style: {
                    ...
                    boxShadow: "0 0 12px rgba(42,111,180,0.25)",
                  },
                  onError: (e) => {
                    e.currentTarget.style.display = "none";
                  },
              ...
              return React.createElement(
                ...
                showPresets &&
                  React.createElement(UnitSelectorModal, {
                    ...
                    faction: isAtk ? aFaction : dFaction,
                    selectedId: unit?.id,
            ...
            React.createElement(
              "div",
              {
                style: {
                  ...
                  boxShadow: "0 0 20px rgba(155,45,45,0.15)",
                  animation: "fadeIn 0.3s ease",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
              ...
              React.createElement(
                ...
                React.createElement("img", {
                  ...
                  style: {
                    ...
                    boxShadow: "0 0 12px rgba(155,45,45,0.35)",
                  },
                  onError: (e) => {
                    e.currentTarget.style.display = "none";
                  },
